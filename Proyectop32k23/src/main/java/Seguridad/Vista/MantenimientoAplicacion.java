 ...
 * @author vjere
 */
public class MantenimientoAplicacion extends javax.swing.JFrame {
    ...
    public MantenimientoAplicacion() {
        ...
        this.setExtendedState(MantenimientoAplicacion.MAXIMIZED_BOTH);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MantenimientoAplicacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MantenimientoAplicacion().setVisible(true);
            }
        });
    }
