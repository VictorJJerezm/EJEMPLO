 ...
 * @author vjere
 */
public class MantenimientoModulos extends javax.swing.JFrame {
    ...
    /**
     * Creates new form MantenimientoModulos
     */
    public MantenimientoModulos() {
        initComponents();
        llenadoDeTablas();
        llenadoDeCombos();
        setLocationRelativeTo(null);
        this.setExtendedState(MantenimientoModulos.MAXIMIZED_BOTH);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MantenimientoModulos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MantenimientoModulos().setVisible(true);
            }
        });
    }
